...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $criteriaC1 = array("options" => array("min_range"=>1, "max_range"=>12));
    $criteriaC2 = array("options" => array("min_range"=>1));
    $criteriaC3 = array("options" => array("min_range"=>1, "max_range"=>5));
    $criteriaC4 = array("options" => array("min_range"=>1, "max_range"=>4));
    $criteriaC5 = array("options" => array("min_range"=>0));
    $criteriaC6 = array("options" => array("min_range"=>1, "max_range"=>10));
...
<div class="col-md-12">
    <div class="page-header text-center">
        <h1>Penilai Kriteria pada setiap Alternatif</h1>
        <h4><?php echo $pemilihan['keterangan']; ?></h4>
    </div>
    <h3>Penilai Kriteria pada setiap Alternatif</h3>
    <form method="post">
        <?php
                ...
                for($i = 0; $i < count($alternatif); $i++) {
                    if (isset($nilai[$i])) {
                        echo '<tr>
                                <td class="col-md-1">'.($i+1).'</td>
                                <td class="col-md-3">'.$alternatif[$i]['alternatif'].'</td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[0][]" placeholder="1 - 12" value="'.$nilai[$i]['c1'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[1][]" placeholder="1 - n" value="'.$nilai[$i]['c2'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[2][]" placeholder="1 - 5" value="'.$nilai[$i]['c3'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[3][]" placeholder="1 - 4" value="'.$nilai[$i]['c4'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[4][]" placeholder="0 - n" value="'.$nilai[$i]['c5'].'"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[5][]" placeholder="1 - 10" value="'.$nilai[$i]['c6'].'"/></td>
                            </tr>';
                    } else {
                        echo '<tr>
                                <td class="col-md-1">'.($i+1).'</td>
                                <td class="col-md-3">'.$alternatif[$i]['alternatif'].'</td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[0][]" placeholder="1 - 12"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[1][]" placeholder="1 - n"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[2][]" placeholder="1 - 5"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[3][]" placeholder="1 - 4"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[4][]" placeholder="0 - n"/></td>
                                <td class="col-md-1"><input class="form-control" type="text" name="c[5][]" placeholder="1 - 10"/></td>
                            </tr>';
                    }
                }
            } else {
